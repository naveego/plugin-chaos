...
using PluginChaos.API.Discover;
using PluginChaos.API.Read;
using PluginChaos.API.Write;
using PluginChaos.DataContracts;
using PluginChaos.Helper;

namespace PluginChaos.Plugin
{
    public class Plugin : Publisher.PublisherBase
    {
            ...
            ServerCallContext context)
        {
            ...
            if (request.Mode == DiscoverSchemasRequest.Types.Mode.All)
            {
                ...
                try
                {
                    var schemas = Discover.GetAllSchemas(_server.Settings, sampleSize);
            ...
            try
            {
                       ...
                       _server.WriteConfigured)
                {
                    ...
                    else
                    {
                        ...
                        Task.Run(async () =>
                                await Write.WriteRecordAsync(schema, record, responseStream),
