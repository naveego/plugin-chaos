...
namespace PluginChaosTest.Plugin
{
    public class PluginIntegrationTest
    {
        ...
        private Schema GetTestSchema(string endpointId = null, string id = "test", string name = "test")
        {
            Endpoint endpoint = endpointId == null
                ? EndpointHelper.GetEndpointForId("TestEndpoint")
        ...
        public async Task ConnectSessionTest()
        {
            ...
            {
                Services = {Publisher.BindService(new PluginChaos.Plugin.Plugin())},
        ...
        public async Task ReadStreamTest()
        {
            ...
            var schema = GetTestSchema("TestEndpoint");
            ...
            Assert.Equal("Chaos", record["company"]);
        ...
        [Fact]
        public async Task ReadStreamTestDuplicate()
        {
            // setup
            Server server = new Server
            {
            ...
            var schema = GetTestSchema("DuplicateEndpoint", "DuplicateEndpoint", "Duplicate Endpoint");
            ...
            Assert.NotEqual(1, records.Count);
        ...
        [Fact]
        public async Task ReadStreamThrowsException()
        {
            // setup
            Server server = new Server
            {
            ...
            var schema = GetTestSchema("ThrowsExceptionEndpoint", "ThrowsExceptionEndpoint",
                "ThrowsException Endpoint");
            ...
            // assert
            //Exception e = Assert.Throws<Exception>(() => client.ReadStream(request));
        ...
        [Fact]
        public async Task ReadStreamLongPause()
        {
            // setup
            Server server = new Server
            {
            ...
            var schema = GetTestSchema("LongPauseEndpoint", "LongPauseEndpoint", "LongPause Endpoint");
        ...
        [Fact]
        public async Task ReadStreamRandomInterval()
        {
            // setup
            var startTime = DateTime.Now;
            Server server = new Server
            ...
            var schema = GetTestSchema("RandomIntervalEndpoint", "RandomIntervalEndpoint",
                "RandomInterval Endpoint");
            ...
            // assert
            var totalTime = endTime - startTime;
            Assert.InRange(totalTime, TimeSpan.FromMilliseconds(100), TimeSpan.FromMilliseconds(5100));
        ...
        [Fact]
        public async Task ReadStreamMaybeReturn()
        {
            // setup
            Server server = new Server
            {
            ...
            var schema = GetTestSchema("MaybeReturnEndpoint", "MaybeReturnEndpoint",
                "MaybeReturn Endpoint");
        ...
        [Fact]
        public async Task ReadStreamRandomData()
        {
            // setup
            Server server = new Server
            {
            ...
            var schema = GetTestSchema("RandomDataEndpoint", "RandomDataEndpoint",
                "RandomData Endpoint");
